            ...
            <Paper className={classes.root}>
                <TableContainer className={classes.container}>
                    <Table stickyHeader aria-label="sticky table">
                        <TableHead >
                            <StyledTableRow >
                                <TableCell style={{ backgroundColor: '#373131', color: 'white' }}>Associated Symptoms</TableCell>
                                <TableCell style={{ backgroundColor: '#373131', color: 'white' }}>English </TableCell>
                                <TableCell style={{ backgroundColor: '#373131', color: 'white' }}>Hindi </TableCell>
