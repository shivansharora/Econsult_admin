...
const steps = ['Personal Info', 'Education Info', 'Certificates/ID', 'Notification'];
        ...
        <Grid item xs={12} sm={9} md={9} >
          <main className={classes.layout}>
            <Paper className={classes.paper}>
              <Typography component="h1" variant="h4" style={{ color: '#3d8588' }} align="center">
                Doctor Details
          </Typography>
