export default function validate(values) {
  ...
  if (!values.experience) {
    ...
    errors.experience = 'User must write digits only not characters';
  }
  /////////////////////////// default_language //////////////////////////////////////
  if (!values.default_language) {
    errors.default_language = 'Default Language is required';
  }
  ///////////////////////////////// medical_registration_no ///////////////////////////////  
  if (!values.medical_registration_no) {
    errors.medical_registration_no = 'Medical Registration No is required';
  }else if (isNaN(values.medical_registration_no)) {
    errors.medical_registration_no = 'User must write digits only not characters';
  }
