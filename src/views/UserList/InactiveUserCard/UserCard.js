    ...
    >
      <CardContent className={classes.content}>
        ...
        <div className={classes.stats}>
          ...
          <Typography style={{ fontSize: 'unset', fontWeight: 300 }} variant="h6">{user.username}</Typography>

        </div>
        <div className={classes.stats}>
          <Typography style={{ fontWeight: 500 }} variant="body2">Mode</Typography>
          <Typography style={{ fontSize: 'unset', fontWeight: 500, color: '#ee5e19' }} variant="h6">{user.mode}</Typography>

        </div>
        <div className={classes.stats}>
          <Typography style={{ fontWeight: 500 }} variant="body2">Registered Date</Typography>
          <Typography style={{ fontSize: 'unset', fontWeight: 300 }} variant="h6">
            {moment(user.start_date).format('DD MMMM YYYY')}
          </Typography>
        ...
        <div className={classes.actions}>
          <Typography style={{ fontWeight: 500, marginLeft: 8 }} variant="body2">Action</Typography>
          <Link
            color="inherit"
            component={RouterLink}
          ...
          {/* <Link
            ...
            variant="h6"
          >
            <Tooltip title="Change Mode" aria-label="Change Mode"> 
            <Fab  className={classes.fab1}>

            <Dialog onClick={props.changed} />
            </Fab>
          </Tooltip>
          </Link> */}
